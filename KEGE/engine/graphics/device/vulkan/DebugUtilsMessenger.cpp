...
namespace kege{namespace vk{
    ...
    const VkDebugUtilsMessengerCreateInfoEXT& DebugUtilsMessenger::info()const
    {
        return _info;
    }

    VkResult DebugUtilsMessenger::construct( const Instance& instance )
    {
        _instance = &instance;
        return vk::debugUtilsMessengerEXT( instance.handle(), &_info, nullptr, &_handle );
    }

    const VkDebugUtilsMessengerEXT DebugUtilsMessenger::handle()const
    {
        return _handle;
    }

    void DebugUtilsMessenger::destruct()
    {
    ...
    ,   _sid( "VK_LAYER_KHRONOS_validation" )
    {
        _info = {};
